> [⬅ Tema: 01 - Fundamentos](README.md)

# 01.0 - Começa por aqui
...
1. `01.1-arquitetura-camadas.md`
2. `01.2-rest-dto-validacao.md`
3. `02.0-service-transacoes.md`
4. `02.1-jpa-entidades-relacionamentos.md`
5. `02.3-seguranca-jwt.md`
6. `02.4-exception-handler.md`
7. `04.1-codigos-http-da-api-explicados.md`
8. `04.0-anotacoes-do-spring-e-jpa-explicadas.md`
...
> [➡ Próximo: 01.1 - Arquitetura em camadas](01.1-arquitetura-camadas.md)
