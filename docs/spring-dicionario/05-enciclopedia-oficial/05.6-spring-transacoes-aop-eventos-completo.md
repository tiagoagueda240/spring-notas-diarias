> [⬅ Anterior: 05.5 - Spring Data JPA completo](05.5-spring-data-jpa-completo.md)

# 05.6 - Spring Transações, AOP e eventos completo
...
> [➡ Próximo: 05.7 - Spring Security completo](05.7-spring-security-completo.md)
