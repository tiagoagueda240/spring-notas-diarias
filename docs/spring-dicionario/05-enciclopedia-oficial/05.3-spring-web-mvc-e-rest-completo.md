> [⬅ Anterior: 05.2 - Spring Boot completo: auto-configuração, starters e propriedades](05.2-spring-boot-autoconfiguracao-starters-propriedades.md)

# 05.3 - Spring Web MVC e REST completo
...
> [➡ Próximo: 05.4 - Spring WebFlux (reativo) completo](05.4-spring-webflux-reactivo-completo.md)
