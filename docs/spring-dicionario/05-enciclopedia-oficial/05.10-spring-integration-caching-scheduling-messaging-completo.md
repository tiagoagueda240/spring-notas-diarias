> [⬅ Anterior: 05.9 - Spring em produção: Actuator, métricas, logs e observabilidade](05.9-spring-producao-actuator-observabilidade-completo.md)

# 05.10 - Spring Integration: Caching, Scheduling, Async e Messaging
...
> [➡ Próximo: 05.11 - Spring Data Access: JDBC e R2DBC completo](05.11-spring-data-access-jdbc-r2dbc-completo.md)
