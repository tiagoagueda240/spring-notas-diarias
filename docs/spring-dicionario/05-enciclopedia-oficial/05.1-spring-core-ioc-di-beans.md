> [⬅ Anterior: 05.0 - Spring Framework: visão geral completa](05.0-spring-framework-visao-geral-completa.md)

# 05.1 - Spring Core completo: IoC, DI e Beans
...
> [➡ Próximo: 05.2 - Spring Boot completo: auto-configuração, starters e propriedades](05.2-spring-boot-autoconfiguracao-starters-propriedades.md)
