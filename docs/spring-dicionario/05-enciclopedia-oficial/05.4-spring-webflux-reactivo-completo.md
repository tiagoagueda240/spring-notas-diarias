> [⬅ Anterior: 05.3 - Spring Web MVC e REST completo](05.3-spring-web-mvc-e-rest-completo.md)

# 05.4 - Spring WebFlux (reativo) completo
...
> [➡ Próximo: 05.5 - Spring Data JPA completo](05.5-spring-data-jpa-completo.md)
