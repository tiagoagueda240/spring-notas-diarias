> [⬅ Tema: 04 - Referência rápida](README.md)

# 04.0 - Anotações do Spring e JPA explicadas
...
> [➡ Próximo: 04.1 - Códigos HTTP da API explicados](04.1-codigos-http-da-api-explicados.md)
