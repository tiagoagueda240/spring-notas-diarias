> [⬅ Anterior: 04.0 - Anotações do Spring e JPA explicadas](04.0-anotacoes-do-spring-e-jpa-explicadas.md)

# 04.1 - Códigos HTTP da API explicados
...
> [➡ Próximo: 04.2 - Mapa completo de endpoints](04.2-mapa-completo-de-endpoints.md)
