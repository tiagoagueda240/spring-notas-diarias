> [⬅ Anterior: 02.0 - Service + Transações](02.0-service-transacoes.md)

# 02.1 - JPA Entidades e Relacionamentos
...
> [➡ Próximo: 02.2 - Repositories e Queries](02.2-repositories-queries.md)
