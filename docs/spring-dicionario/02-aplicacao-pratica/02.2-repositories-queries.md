> [⬅ Anterior: 02.1 - JPA Entidades e Relacionamentos](02.1-jpa-entidades-relacionamentos.md)

# 02.2 - Repositories e Queries
...
> [➡ Próximo: 02.3 - Segurança JWT com Spring Security](02.3-seguranca-jwt.md)
